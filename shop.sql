...
--
-- Name: status_history; Type: TABLE; Schema: shop; Owner: postgres
--

CREATE TABLE shop.status_history (
    id integer NOT NULL,
    order_id integer,
    old_status integer,
    new_status integer,
...
ALTER TABLE shop.status_history OWNER TO postgres;
...
ALTER SEQUENCE shop.status_history_id_seq OWNED BY shop.status_history.id;
...
--
-- Name: status_history id; Type: DEFAULT; Schema: shop; Owner: postgres
--

ALTER TABLE ONLY shop.status_history ALTER COLUMN id SET DEFAULT nextval('shop.status_history_id_seq'::regclass);
...
COPY shop.delivery (order_id, sum_weight, date_of_delivery, delivery_price, personnel_number, delivery_status) FROM stdin;
\.
...
COPY shop."order" (id, date_of_order, order_status, final_price, payment_method, method_of_obtaining, personnel_number, storage_id, login) FROM stdin;
\.
...
--
-- Data for Name: status_history; Type: TABLE DATA; Schema: shop; Owner: postgres
--

COPY shop.status_history (id, order_id, old_status, new_status, change_date) FROM stdin;
\.
...
--
-- Name: status_history status_history_pkey; Type: CONSTRAINT; Schema: shop; Owner: postgres
--

ALTER TABLE ONLY shop.status_history
...
ALTER TABLE ONLY shop.delivery
    ADD CONSTRAINT delivery_delivery_status_fkey FOREIGN KEY (delivery_status) REFERENCES supporting_directories.devilery_status(id);
...
ALTER TABLE ONLY shop."order"
    ADD CONSTRAINT order_method_of_obtaining_fkey FOREIGN KEY (method_of_obtaining) REFERENCES supporting_directories.method_of_obtaining(id);
...
ALTER TABLE ONLY shop."order"
    ADD CONSTRAINT order_order_status_fkey FOREIGN KEY (order_status) REFERENCES supporting_directories.order_status(id);
...
ALTER TABLE ONLY shop."order"
    ADD CONSTRAINT order_payment_method_fkey FOREIGN KEY (payment_method) REFERENCES supporting_directories.payment_method(id);
...
--
-- Name: status_history status_history_fk; Type: FK CONSTRAINT; Schema: shop; Owner: postgres
--
...
--
-- Name: status_history status_history_fk_1; Type: FK CONSTRAINT; Schema: shop; Owner: postgres
--

ALTER TABLE ONLY shop.status_history
    ADD CONSTRAINT status_history_fk_1 FOREIGN KEY (old_status) REFERENCES supporting_directories.order_status(id);


--
-- Name: status_history status_history_fk_2; Type: FK CONSTRAINT; Schema: shop; Owner: postgres
--

ALTER TABLE ONLY shop.status_history
    ADD CONSTRAINT status_history_fk_2 FOREIGN KEY (new_status) REFERENCES supporting_directories.order_status(id);
